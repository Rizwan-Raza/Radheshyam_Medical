...
import com.cspoint.radheshyam.model.CartValidate;
...
import com.cspoint.radheshyam.utiles.MyCart;
...
import static com.cspoint.radheshyam.ui.AddressActivity.changeAddress;
...
public class CartActivity extends RootActivity implements GetResult.MyListener {
    ...
    private void cartdataset() {
        ...
        while (res.moveToNext()) {
            ...
            Log.d("lll", "cartdataset: " + rModel.toString());
...
//
//
            int qrt = helper.getCart(myCart.getPid());
            if (qrt != -1) {
                count[0] = qrt;
...
//                    helper.deleteRData(myCart.getAttributeId());
                    helper.deleteCData(myCart.getPid());
                    mData.remove(myCart);
